...
!function (t) {
  ...
  var t;return function t(e, n, r) {
    function i(u, s) {
      if (!n[u]) {
        if (!e[u]) {
          var a = "function" == typeof commonjsRequire && commonjsRequire;if (!s && a) return a(u, !0);if (o) return o(u, !0);var c = new Error("Cannot find module '" + u + "'");throw c.code = "MODULE_NOT_FOUND", c;
        }var f = n[u] = { exports: {} };e[u][0].call(f.exports, function (t) {
          var n = e[u][1][t];return i(n || t);
        }, f, f.exports, t, e, n, r);
      }return n[u].exports;
    }for (var o = "function" == typeof commonjsRequire && commonjsRequire, u = 0; u < r.length; u++) i(r[u]);return i;
  }({ 1: [function (t, e, n) {
      (function (n) {
        function r(t, e) {
          function n(t) {
      ...
      (function (e) {
        (function () {
          ...
          }();"function" == typeof t && "object" == typeof t.amd && t.amd ? (Cn._ = Hn, t(function () {
            return Hn;
      ...
      !function (e, i) {
        "object" == typeof r && void 0 !== n ? i(r) : "function" == typeof t && t.amd ? t(["exports"], i) : i(e.URI = e.URI || {});
      }(this, function (t) {
        function e() {
...
var languageSelect = {
    main({ langs, getLanguageFromCode, followParams, $p }) {
        ...
        }, langs.map(({ code }) => ['option', { value: code }, [getLanguageFromCode(code)]])]], document.body);
    }
...
var workDisplay = {
    ...
    */
        ...
        ['td', [String(idx)]], le('check-columns-to-browse', 'td', 'title', {}, [le('yes', 'input', 'value', {
            ...
            checked: $p.get(checkedIndex) === l('no') ? undefined : 'checked',
            type: 'checkbox'
        })]), le('check-sequence', 'td', 'title', {}, [['select', { name: iil('field') + idx, id: fieldIndex, size: '1' }, fields.map((field, j) => {
            const fn = getFieldAliasOrName(field) || field;
            const matchedFieldParam = fieldParam && fieldParam === field;
            return matchedFieldParam || !$p.has(fieldIndex) && j === i ? ['option', {
                dataset: { name: field }, value: fn, selected: 'selected'
            }, [fn]] : ['option', { dataset: { name: field }, value: fn }, [fn]];
    ...
    advancedFormatting: ({ ld, il, l, lo, le, $p, hideFormattingSection }) => ['td', {
    ...
    }, [['h3', [ld('advancedformatting')]], ['label', [ld('textcolor'), nbsp.repeat(2), ['select', { name: il('colorName') }, colors.map((color, i) => {
    ...
    })]]], ['label', [nbsp, ld('or_entercolor'), nbsp.repeat(2), ['input', {
        name: il('color'),
        type: 'text',
        value: $p.get('color') || '#',
        size: '7',
        maxlength: '7' }]]], ['br'], ['br'], ['label', [ld('backgroundcolor'), nbsp.repeat(2), ['select', { name: il('bgcolorName') }, colors.map((color, i) => {
        const atts = { value: l(['param_values', 'colors', color]) };
        ...
        value: $p.get('bgcolor') || '#',
        size: '7',
        maxlength: '7' }]]], ['br'], ['br'], ['label', [ld('text_font'), nbsp.repeat(2),
    ...
    })]]], ['br'], ['br'], ['label', [ld('font_style'), nbsp.repeat(2), ['select', { name: il('fontstyle') }, ['italic', 'normal', 'oblique'].map((fontstyle, i) => {
    ...
    })]]], ['br'], ['div', [ld('font_variant'), nbsp.repeat(3), ['label', [['input', {
        name: il('fontvariant'),
        type: 'radio',
        value: l('normal'),
        checked: $p.get('fontvariant') === ld(['param_values', 'fontvariant', 'smallcaps']) ? undefined : 'checked' }], ld(['param_values', 'fontvariant', 'normal']), nbsp]], ['label', [['input', {
        name: il('fontvariant'),
        type: 'radio',
        value: l('smallcaps'),
        checked: $p.get('fontvariant') === ld(['param_values', 'fontvariant', 'smallcaps']) ? 'checked' : undefined }], ld(['param_values', 'fontvariant', 'smallcaps']), nbsp]]]], ['br'], ['label', [
    // Todo: i18n and allow for normal/bold pulldown and float input?
    ld('font_weight'), ' (normal, bold, 100-900, etc.):', nbsp.repeat(2), ['input', {
        name: il('fontweight'),
        type: 'text',
        value: $p.has('fontweight') ? $p.get('fontweight') : 'normal',
        size: '7',
        maxlength: '12' }]]], ['br'], ['label', [ld('font_size'), ' (14pt, 14px, small, 75%, etc.):', nbsp.repeat(2), ['input', {
        name: il('fontsize'),
        type: 'text',
    ...
    ['br'], ['br'], ['label', [ld('letter_spacing'), ' (normal, .9em, -.05cm): ', ['input', {
        ...
        size: '7',
        maxlength: '12' }]]], ['br'], ['br'], le('tableformatting_tips', 'h3', 'title', {}, [ld('tableformatting')]), ['div', [ld('header_wstyles'), nbsp.repeat(2), ...[['yes', ld(['param_values', 'y'])], ['no', ld(['param_values', 'n'])], ['none', ld(['param_values', '0'])]].map(([key, val], i, arr) => ['label', [['input', {
        name: il('header'),
        type: 'radio',
        value: val,
        checked: $p.get('header') === val || !$p.has('header') && i === 1 ? 'checked' : undefined }], ld(key), i === arr.length - 1 ? '' : nbsp.repeat(3)]])]], ['div', [ld('footer_wstyles'), nbsp.repeat(2), ...[['yes', ld(['param_values', 'y'])], ['no', ld(['param_values', 'n'])], ['none', ld(['param_values', '0'])]].map(([key, val], i, arr) => ['label', [['input', {
        name: il('footer'),
        type: 'radio',
        value: val,
        checked: $p.get('footer') === val || !$p.has('footer') && i === 2 ? 'checked' : undefined }], ld(key), i === arr.length - 1 ? '' : nbsp.repeat(3)]])]], ['label', [['input', {
        name: il('headerfooterfixed'),
        type: 'checkbox',
        value: l('yes'),
        checked: $p.get('headerfooterfixed') === l('yes') ? 'checked' : undefined }], nbsp.repeat(2), ld('headerfooterfixed-wishtoscroll')]], ['br'], ['div', [ld('caption_wstyles'), nbsp.repeat(2), ...[['yes', ld(['param_values', 'y'])], ['no', ld(['param_values', 'n'])], ['none', ld(['param_values', '0'])]].map(([key, val], i, arr) => ['label', [['input', {
        name: il('caption'),
        type: 'radio',
        value: val,
        checked: $p.get('caption') === val || !$p.has('caption') && i === 2 ? 'checked' : undefined }], ld(key), i === arr.length - 1 ? '' : nbsp.repeat(3)]])]], ['br'], ['div', [ld('table_wborder'), nbsp.repeat(2), ['label', [['input', {
        name: il('border'),
        type: 'radio',
        value: '1',
        checked: $p.get('border') === '0' ? undefined : 'checked' }], ld('yes'), nbsp.repeat(3)]], ['label', [['input', {
        name: il('border'),
        type: 'radio',
        value: '0',
        checked: $p.get('border') === '0' ? 'checked' : undefined }], ld('no')]]]], ['div', [ld('interlin_repeat_field_names'), nbsp.repeat(2), ['label', [['input', {
        name: il('interlintitle'),
        type: 'radio',
        value: '1',
        checked: $p.get('interlintitle') === '0' ? undefined : 'checked' }], ld('yes'), nbsp.repeat(3)]], ['label', [['input', {
        name: il('interlintitle'),
        type: 'radio',
        value: '0',
        checked: $p.get('interlintitle') === '0' ? 'checked' : undefined }], ld('no')]]]], ['label', [ld('interlintitle_css'), nbsp.repeat(2), ['input', {
    ...
    */
    ...
    ['br'],
    */
    ['label', [ld('page_css'), nbsp.repeat(2), ['textarea', {
        name: il('pagecss'),
        title: l('page_css_tips'),
        value: $p.get('pagecss')
    }]]], ['br'], le('outputmode_tips', 'label', 'title', {}, [ld('outputmode'), nbsp.repeat(2),
    ...
    addRandomFormFields: ({
        ...
        ['label', [ld('rnd'), nbsp.repeat(3), ['input', {
            id: 'rand',
            name: il('rand'),
            type: 'checkbox',
            value: l('yes'),
            checked: $p.get('rand') === l('yes') ? 'checked' : undefined
        }]]], nbsp.repeat(3), ['label', [ld('verses-context'), nbsp, ['input', {
            name: il('context'),
            type: 'number',
            min: 1,
            size: 4,
            value: $p.get('context')
        }]]], nbsp.repeat(3), le('view-random-URL', 'input', 'value', {
            type: 'button',
            $on: {
                click: () => {
    ...
    addBrowseFields: ({ browseFields, fields, getFieldAliasOrName, ld, i, iil, $p, content }) => {
        ...
        i > 0 ? [['td', { colspan: 12, align: 'center' }, [['br'], ld('or'), ['br'], ['br']]]] : '', [...function () {
            const addBrowseFieldSet = setType => browseFields.reduce((rowContent, { fieldName, aliases, fieldSchema: { minimum, maximum } }, j) => {
            ...
            return [addBrowseFieldSet('start'), ['td', [['b', [ld('to')]], nbsp.repeat(3)]], addBrowseFieldSet('end')];
        }(), ['td', [browseFields.length > 1 ? ld('versesendingdataoptional') : '']]], [['td', { colspan: 4 * browseFields.length + 2 + 1, align: 'center' }, [['table', [['tr', [browseFields.reduce((rowContent, { fieldName, aliases, fieldSchema: { minimum, maximum } }, j) => {
            ...
            return rowContent;
        }, { '#': [['td', { style: 'font-weight: bold; vertical-align: bottom;' }, [ld('anchored-at') + nbsp.repeat(3)]]] }), ['td', [['label', [ld('field') + nbsp.repeat(2), ['select', { name: iil('anchorfield') + (i + 1), size: '1' }, fields.map((field, j) => {
            const fn = getFieldAliasOrName(field) || field;
            return ['option', [fn]];
...
var resultsDisplay = {
    ...
    ranges({ l, startRange, endVals, rangeNames }) {
        return startRange +
        // l('to').toLowerCase() + ' ' +
        '-' + endVals.join(Templates.resultsDisplay.startSeparator({ l })) + ' (' + rangeNames + ')';
    },
    ...
    anchors({ escapedRow, escapedCol }) {
        const sel = 'td[data-row="' + escapedRow + '"]' + (escapedCol ? '[data-col="' + escapedCol + '"]' : '');
        return $(sel);
    },
...
` : '')]];
    ...
    main({
        ...
        tableData.some((tr, i) => {
            ...
            outArr.push(addChildren(trElem, checkedFieldIndexes.map((idx, j) => {
                ...
                const interlins = showInterlins && interlinearColIndexes.map(idx => {
                    ...
                    return showInterlins && !cellIsEmpty ? Templates.resultsDisplay.interlinearSegment({
                        lang: fieldLangs[idx],
                ...
                return addAtts(tdElem, {
                    ...
                    innerHTML: (showInterlins && !checkEmpty(tdVal, htmlEscaped) && (showTitleOnSingleInterlinear || interlins.length) ? Templates.resultsDisplay.interlinearSegment({
                        lang: fieldLangs[idx],
                        html: Templates.resultsDisplay.interlinearTitle({
                            l, val: localizedFieldNames[idx]
                        }) + tdVal
        ...
        jml('div', [Templates.resultsDisplay.styles({
        ...
        */
        ...
        }))]) : '', $pRaw('footer') !== '0' ? addChildren(tfootElem, [addChildren(trElem, checkedFields.map((cf, i) => {
            const interlinearColIndexes = allInterlinearColIndexes[i];
            cf = escapeHTML(cf) + (interlinearColIndexes ? l('comma-space') + interlinearColIndexes.map(idx => localizedFieldNames[idx]).join(l('comma-space')) : '');
            return addChildren(thElem, [cf, tableWithFixedHeaderAndFooter ? ['div', { class: 'zupa1' }, [['div', { class: 'th-inner' }, [['span', [cf]]]]]] : '']);
        }))]) : '', addChildren(tbodyElem, outArr)])])], document.body);
    }
};
...
Templates.permissions = {
    ...
    main({ l, ok, refuse, close, closeBrowserNotGranting }) {
        const requestPermissionsDialog = jml('dialog', {
        ...
        const browserNotGrantingPersistenceAlert = jml('dialog', {
...
function workSelect$1({
    lang, localeFromFileData, fallbackLanguages, getMetaProp, $p, followParams /* , l, defineFormatter */ }) {
    ...
    this.getFilesData().then(dbs => {
        ...
        const imfFile = IMFClass({ // eslint-disable-line new-cap
...
function workDisplay$1({
    ...
    function _displayWork(l, schemaObj, metadataObj, getFieldAliasOrName) {
        ...
        function fieldMatchesLocale(field) {
            const metaFieldInfo = metadataObj && metadataObj.fields && metadataObj.fields[field];
            let metaLang;
            if (metaFieldInfo) {
            ...
            const preferredLanguages = getPreferredLanguages(langCodes && JSON.parse(langCodes) || [preferredLocale]);
    ...
    this.getWorkData({ lang, localeFromFileData, fallbackLanguages, $p, getMetaProp }).then(([fileData, lf, getFieldAliasOrName, schemaObj, metadataObj, pluginKeys, pluginFieldMappings, pluginObjects]) => {
        document.title = lf({
            key: 'browserfile-workdisplay',
            values: {
                work: fileData ? getMetaProp(metadataObj, 'alias') : ''
            },
            fallback: true
        });
...
function resultsDisplay$1({
    ...
    const determineEnd = ({
        ...
        if (!foundState.start) {
            if (starts.some((part, i) => {
                ...
                return Array.isArray(rowIDPart) ? !rowIDPart.some(rip => starts[i] === String(rip)) : rowIDPart && typeof rowIDPart === 'object' ? !Object.values(rowIDPart).some(rip => starts[i] === String(rip)) : starts[i] !== String(rowIDPart);
            })) {
                return false;
            }
        ...
        if (ends.every((part, i) => {
            const rowIDPart = rowIDParts[i];
            return Array.isArray(rowIDPart) ? rowIDPart.some(rip => ends[i] === String(rip)) : rowIDPart && typeof rowIDPart === 'object' ? Object.values(rowIDPart).some(rip => ends[i] === String(rip)) : ends[i] === String(rowIDPart);
        })) {
            foundState.end = true;
        ...
        if (hasCaption) {
            ...
            */
            ...
            const buildRanges = () => {
                ...
                return escapeHTML(Templates.resultsDisplay.ranges({ l, startRange, endVals, rangeNames }));
            };
            ...
            if (fieldValueAliasMap) {
                Object.entries(fieldValueAliasMap).forEach(([key, val]) => {
                    if (Array.isArray(val)) {
                        fieldValueAliasMap[key] = val.map(value => Templates.resultsDisplay.fieldValueAlias({ key, value }));
                        return;
                    }
                    if (val && typeof val === 'object') {
                        if (usePreferAlias && typeof preferAlias === 'string') {
                            fieldValueAliasMap[key] = Templates.resultsDisplay.fieldValueAlias({
                                key, value: val[preferAlias]
                            });
                        } else {
                            Object.entries(val).forEach(([k, value]) => {
                                fieldValueAliasMap[key][k] = Templates.resultsDisplay.fieldValueAlias({
                                    key, value
                                });
                            });
                        }
                    ...
                    fieldValueAliasMap[key] = Templates.resultsDisplay.fieldValueAlias({ key, value: val });
                });
    ...
    this.getWorkData({ lang, localeFromFileData, fallbackLanguages, $p, getMetaProp }).then(([fileData, lf, getFieldAliasOrName, schemaObj, metadataObj, pluginKeys, pluginFieldMappings, pluginObjects]) => {
        ...
        const buildRangePoint = startOrEnd => applicableBrowseFieldNames.map((bfn, j) =>
        // Todo: i18nize?
        $p.get(startOrEnd + (browseFieldSetIdx + 1) + '-' + (j + 1), true));
        ...
        navigator.storage.persisted().then(persistent => {
            ...
            if (!this.skipIndexedDB && persistent && navigator.serviceWorker.controller) {
                ...
                if (presort || this.noDynamic) {
                    ...
                    return fetch(Object.entries({
                        unlocalizedWorkName, startsRaw, endsRaw
                    }).reduce((url, [arg, argVal]) => {
                        return url + '&' + arg + '=' + encodeURIComponent(JSON.stringify(argVal));
                    }, 'textbrowser?')).then(r => r.json());
                }
            }
        }).then(tableData => {
...
TextBrowser.prototype.workSelect = workSelect$1;
TextBrowser.prototype.workDisplay = workDisplay$1;
TextBrowser.prototype.resultsDisplay = resultsDisplay$1;
    ...
    return this.getFilesData().then(filesObj => {
        ...
        filesObj.groups.forEach(fileGroup => {
            fileGroup.files.forEach(fileData => {
                const { file, schemaFile, metadataFile } = this.getFilePaths(filesObj, fileGroup, fileData);
...
TextBrowser.prototype.getWorkData = function ({
    ...
    return this.getFilesData().then(filesObj => {
        ...
        const getMetadata = (file, property, cb) => JsonRefs.resolveRefsAt(getCurrDir() + file + (property ? '#/' + property : '')).then(({ resolved }) => resolved).catch(err => {
            alert('catch:' + err);
            throw err;
        });
        ...
        return getMetadata(metadataFile, metadataProperty).then(metadataObj => {
            ...
            return Promise.all([fileData, lf, getFieldAliasOrName, // Pass on non-promises
            getMetadata(schemaFile, schemaProperty), metadataObj, getPlugins ? pluginsInWork : null, // Non-promise
            getPlugins ? pluginFieldMappingForWork : null, // Non-promise
            getPlugins ? Promise.all(pluginPaths.map(pluginPath => {
...
TextBrowser.prototype.getDirectionForLanguageCode = function (code) {
    const langs = this.langData.languages;
    return langs.find(lang => lang.code === code).direction;
};
    ...
    if (fieldValueAliasMap) {
        ...
        if (fieldSchema.enum && fieldSchema.enum.length) {
            fieldSchema.enum.forEach(enm => {
                ret.aliases.push(getMetaProp(metadataObj, ['fieldvalue', field, enm], true));
...
TextBrowser.prototype.getBrowseFieldData = function ({
    ...
    metadataObj.table.browse_fields.forEach((browseFieldSetObject, i) => {
        ...
        const browseFields = fieldSets.map(field => this.getFieldNameAndValueAliases({
            field, schemaItems, metadataObj, getFieldAliasOrName, getMetaProp
        }));
...
TextBrowser.prototype.paramChange = function () {
    ...
    const localePass = lcl => langs.map(({ code }) => code).includes(lcl) ? lcl : false;
    ...
    const localeFromLangData = lan => this.langData['localization-strings'][lan];

    const localeFromFileData = lan => this.fileData['localization-strings'][lan];

    const getLanguageFromCode = code => localeFromLangData(code).languages[code];
    ...
    navigator.storage.persisted().then(persistent => {
                    ...
                    Promise.resolve().then(() => {
                        ...
                        switch (requestPermissionsDialog.returnValue) {
                            ...
                            case 'default':
                                return;
                            case 'granted':
                                return Promise.all([this.getWorkFiles(),
                                // Note that it will convert prior caches to
                                //   persistent ones as well
                                navigator.storage.persist()]).then(([userDataFiles, persistent]) => {
                                    if (!persistent) {
                                    ...
                                    */
                                    ...
                                    return navigator.serviceWorker.register(this.serviceWorkerPath).then(r => new Promise((resolve, reject) => {
                                        ...
                                        if (r.installing) {
                                            ...
                                            const localeFiles = langs.map(({ locale: { $ref } }) => (langPathParts.length > 1 ? langPathParts.slice(0, -1).join('/') + '/' : '') + $ref);
        ...
        */
        ...
        const imf = IMFClass({
            ...
            this.langData.localeFileBasePath + langs.find(l => l.code === code).locale.$ref,
